    ...
    let e = require("fs"),
        ...
        o = (r) =>
            e
                ...
                .split("\n")
                .reduce((e, r, o, _) => (o % 2 == 0 && e.push(Array.from({ length: Math.ceil(r.length / 2) }, (e, r) => _[o][2 * r] + _[o][2 * r + 1] + _[o + 1][2 * r] + _[o + 1][2 * r + 1])), e), []),
        _ = (e, r, o) => o < 0 || o >= e.length || r < 0 || r >= e[0].length,
        l = (e, r, o) => {
            if (_(e, r, o)) throw Error("Out of bounds.");
        },
        n = (e) => (r) => (e(r), r),
        $ = 1,
        u = 0,
        ...
        h = [],
        i = (e) => {
            for (; !_(e, d, f); d += $, f += u) w(e), h.push([$, u, d, f, e]);
        },
        c = (e) => {
            ([$, u, d, f, t] = h[h.length - e]), (h = h.slice(0, -e)), i(t);
        },
        ...
        C = () => {
            let e = null;
            for (process.stdin.once("data", (r) => (e = r)); null === e; ) r.runLoopOnce();
            return e.toString().trim();
        },
        p = (e, r) => {
            let o, _;
            return ([o, r] = m(r)), ([_, r] = m(r)), l(e, _ + d, o + f), [_ + d, o + f, r];
        },
        w = (e) => {
            let r = s(e[f][d]),
                o = Math.floor(r / 94),
